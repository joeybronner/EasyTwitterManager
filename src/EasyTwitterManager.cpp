// EasyTwitterManagerCSL.cpp : définit le point d'entrée pour l'application console.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	*/
	...
	//printf( "\nEst-ce qu'un proxy est configuré ? (0 pour non ; 1 pour oui) : " );
    ...
    else
    {
        ...
        if( std::string::npos != tmpStr.find( "1" ) )
        {
            ...
            printf( "\nEntrez le PIN reçu par Twitter: " );
            std::cin >> tmpBuf;
			//gets( tmpBuf );
            tmpStr = tmpBuf;
